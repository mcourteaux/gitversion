...
function (_CREATE_GIT_VERSION_FILE ${TARGET})
  ...
  ENDIF()
  EXECUTE_PROCESS(COMMAND /usr/bin/env python -m gitversionbuilder --lang cpp --dir "${CMAKE_CURRENT_SOURCE_DIR}" "${CMAKE_CURRENT_BINARY_DIR}/messmer_gitversion_${TARGET}/gitversion/version.h"
