...
function (_CREATE_GIT_VERSION_FILE ${TARGET})
  ...
  FILE(MAKE_DIRECTORY "${CMAKE_CURRENT_BINARY_DIR}/messmer_gitversion_${TARGET}/gitversion")
  ...
  ENDIF()
  EXECUTE_PROCESS(COMMAND /usr/bin/env python3 -m gitversionbuilder --lang cpp --dir "${CMAKE_CURRENT_SOURCE_DIR}" "${CMAKE_CURRENT_BINARY_DIR}/messmer_gitversion_${TARGET}/gitversion/version.h"
...
function(_SET_GITVERSION_CMAKE_VARIABLE TARGET OUTPUT_VARIABLE)
  ...
  FILE(READ "${CMAKE_CURRENT_BINARY_DIR}/messmer_gitversion_${TARGET}/gitversion/version.h" VERSION_H_FILE_CONTENT)
